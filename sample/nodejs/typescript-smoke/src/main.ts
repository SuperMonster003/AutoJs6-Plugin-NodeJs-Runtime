...
async function smoke(): Promise<void> {
  ...
  const filesystemWatchers: string = autojsProfile.filesystemProfile.limits.watchers;
  ...
  const processWorkerMessageBudget: string = autojsProfile.processWorkerReplacementProfile.messageBudget;
  ...
  void processWorkerMessageBudget;
